function users(id: string | number, fname: string, role: string){
console.log("id" + id)
...
function users1(id: string | number, fname: string, role?: string){//the ? denotes this param is optional
    console.log("id" + id)
    console.log("fname" + fname)
    console.log("role" + role)
    }
...
function users3(id: string | number, fname: string, role: string = "Ram"){//the = denotes this param is defaulted
    console.log("id" + id)
    console.log("fname" + fname)
    console.log("role" + role)
    }
...
function restParamEx(x: boolean, ...nums: any[]){
console.log(nums)
}
