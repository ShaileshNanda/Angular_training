...
let value2; //typescript knows it is an function but we might call incorrect type value to another function
let value3; //we define what type to pass and whats the return type
value3 = add;
